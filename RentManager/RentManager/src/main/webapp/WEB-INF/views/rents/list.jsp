                    ...
                    <div class="box">
                        <div class="box-body no-padding">
                            <table class="table table-striped">
                                ...
                                <%
                                if(request.getSession().getAttribute("errordeletereservation")!=null){ %>
                                	<p class="alert alert-warning"><%=request.getSession().getAttribute("errordeletereservation")%></p>
                               <% }else{} %>
                               <c:forEach items="${reservations}" var="reservation">
                                <tr> 
                                    <td>${reservation.id}</td>
                                    <td>${reservation.modeleCons}</td>
                                    <td>${reservation.clientNP}</td>
                                    <td>${reservation.debut}</td>
                                    <td>${reservation.fin}</td>
                                    <td>
                                        <!--<a class="btn btn-primary" href="${pageContext.request.contextPath}/cars?id=${reservation.id}">-->
